...
/*! @brief Returns the position of the monitor's window on the virtual screen.
 *
 ...
 *  your window if the framebuffer size has changed.
 *
 ...
 * defined by some opengl.h variants (OpenBSD) so define it after if needed.
 */
#ifndef GLAPIENTRY
